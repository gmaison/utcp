...
`.repeat(3);
        ...
        const compressionResult = (0, index_1.compressString)(trimmedText, 'pride-and-prejudice.txt');
        ...
        const decompressionResult = (0, index_1.decompressString)(compressionResult.compressedContent, 'pride-and-prejudice.txt.utcp');
        // The decompressed content should match the original
        expect(decompressionResult.originalContent).toEqual(trimmedText);
    });
});
