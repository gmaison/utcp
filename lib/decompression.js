...
exports.UTCPDecompressor = void 0;
const path = __importStar(require("path"));
const utils_1 = require("./utils");
class UTCPDecompressor {
    ...
    save() {
        const outputPath = this.determineOutputPath();
        (0, utils_1.writeFile)(outputPath, this.decompressedContent);
        return outputPath;
    }
    /**
    ...
    parseUTCPFormat() {
        ...
        if (this.content.startsWith('<UTCP-v1>')) {
            ...
            this.metadata = {
                ...
                checksum: (0, utils_1.calculateChecksum)(content),
                size: parseInt(sizeMatch[1], 10),
                lines: (0, utils_1.countLines)(content),
            ...
            this.metadata = {
                ...
                checksum: (0, utils_1.calculateChecksum)(contentMatch[1]),
     ...
     */
    applyDecompressionRules(content) {
    ...
    */
    verifyDecompression() {
        ...
        const decompressedChecksum = (0, utils_1.calculateChecksum)(this.decompressedContent);
    ...
    determineOutputPath() {
        ...
        return (0, utils_1.getSuggestedOutputFilename)(this.filePath);
    }
}
exports.UTCPDecompressor = UTCPDecompressor;
